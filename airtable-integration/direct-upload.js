...
// Function to create glaze records with direct image uploads (LIMITED TO 3)
async function createGlazeRecordsWithImages() {
  console.log('Creating 3 glaze records with direct image uploads...');
...
// Function to create underglaze records with direct image uploads (LIMITED TO 3)
async function createUnderglazeRecordsWithImages() {
  console.log('Creating 3 underglaze records with direct image uploads...');
...
// Main function
async function main() {
  console.log('📤 Testing direct image upload to Airtable...\n');
  ...
  try {
    ...
    // Create 3 glaze records with direct image uploads
    const glazeResults = await createGlazeRecordsWithImages();
    
    // Create 3 underglaze records with direct image uploads
    ...
    console.log('\n🎉 Direct image upload test complete!');
    ...
    console.error('Error during direct image upload test:', error.message);
  }
}
